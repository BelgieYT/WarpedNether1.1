...
public class DioEntity extends AnimalEntity {


    public DioEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) { return SoundEvents.ENTITY_VILLAGER_DEATH; }


    @Override
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playSound(SoundEvents.ENTITY_IRON_GOLEM_STEP, 0.25F, 1.5F);
    }
    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        return ModEntityTypes.dio.get().create(this.world);
    }
